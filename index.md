...
[![CRAN
status](https://www.r-pkg.org/badges/version/IBLM)](https://CRAN.R-project.org/package=IBLM)
...
[![CRAN
downloads](https://cranlogs.r-pkg.org/badges/grand-total/IBLM)](https://CRAN.R-project.org/package=IBLM)

------------------------------------------------------------------------

### Overview

**IBLM** implements *Interpretable Boosted Linear Models* — a hybrid
modelling approach that combines the transparency of generalized linear
models (GLMs) with the predictive power of gradient boosting.
...
This is an **R package**. However an equivalent **Python package** is
